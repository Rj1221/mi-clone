  ...
  return (
    <>
      ...
      <div className="PreFooter2">
        <div><p>LET'S STAY IN TOUCH</p><span>Get Updates on sales special and more</span></div>
        <div>
          <div>
            <input type="search" name="search" placeholder='Enter Email Address' />
            <button>›</button>
          </div>
      ...
      <div className="footer">
        ...
        <div>
          <div>Chat with our Virtual AI Bot</div>
          <button>CHAT NOW</button>
        </div>
      </div>
      <div className="footerBorder">
        <div>Copyright © 2020 MI. All rights reserved.
          <p style={ { display: 'inline-flex',float:'right' } }>Cloned By Raj</p>
        </div>
